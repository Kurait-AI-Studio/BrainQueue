...
export function Gallery() {
  ...
  if (_view === "braindump") return <BrainDumpModal onClose={noop} onTasksAdded={noop} weights={undefined} initialParsed={[
    { _pid: "d:0", title: "Pay the EDF electricity bill", category: "Finance", urgency: 5, importance: 4, effort: 1, energy: 1, pleasure: 1, notes: "Due before the 15th to avoid a late fee.", due_date: "2026-07-15", est_minutes: 5, cognitive_load: 1, ai_delegatable: false, multi_step: false, _dup: "Pay the electricity bill" },
